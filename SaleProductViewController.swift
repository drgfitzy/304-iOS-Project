...
class SaleProductViewController: UIViewController, WKNavigationDelegate, UITabBarDelegate, UIScrollViewDelegate {

    var webView: WKWebView!
    
    
    
    let saleClothingURL = "http://www.304clothing.com/clearance.html"
    ...
    override func viewDidLoad() {
        ...
        loadWebURL(urlString: saleClothingURL)
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        let toPoint: CGPoint = CGPoint(x: 0.0, y: -50.0)
        ...
        logoContainer.layer.add(movement, forKey: "move")
        ...
        if screenWidth == 320 && screenHeight == 568 {
            ...
            if percentScrolled > 3 {
                ...
                //logoContainer.center = CGPointMake(160.0, -50.0)
                //UIView.animateWithDuration(1.0, delay: 0, options: [], animations: { self.logoContainer.center.y += self.logoContainer.bounds.height}, completion: nil)
            ...
            else if percentScrolled < 3 {
                
                //logoContainer.center = CGPointMake(160.0, 50.0)
                //UIView.animateWithDuration(2.0, animations: logoContainer.center)
                
                logoContainer.alpha = 1
                logo.alpha = 1
                 //UIView.animateWithDuration(1.0, delay: 0, options: [.Repeat, .Autoreverse], animations: { self.logoContainer.center.y -= self.logoContainer.bounds.height}, completion: nil)
        ...
        if screenWidth == 320 && screenHeight == 480 {
            ...
            if percentScrolled > 3.5 {
                
                logoContainer.alpha = 0
                logo.alpha = 0
            }
                
            else if percentScrolled < 3.5 {
